...
export const cvData = {
  ...
  projects: [
    {
      title: "Data Analyst with Microsot Excel - Ousean Group",
      summary:
        "Proses mencakup pembersihan data untuk diolah dan dianalisis dengan statistik deskriptif, hingga visualisasi data",
    ...
    },
    {
      ...
      summary:
        "Membuat visualisasi data menggunakan Microsoft Excel untuk menampilkan data produksi dan pengeluaran ternak secara informatif",
    ...
    },    
    {
      ...
      summary: "Membuat infografis menggunakan Canva dengan penerapan prinsip desain visual tentang daya saing tenaga kerja Indonesia di ASEAN.",
    ...
    },
    {
      ...
      summary:
        "Infografis bertema etika digital yang diinformasikan dengan desain grafis ",
